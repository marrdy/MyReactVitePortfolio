...
function AboutMe() {
  return (
    <div className='text-white text-left py-16 ml-16 mr-16' id="About-me">
        ...
        <div className='md:flex justify-center items-center md:justify-start'>
            <img src={mypic} className='mx-auto rotate-0 w-48 h-56 shadow-md border-8 md:w-72 md:h-96 md:m-0 md:rotate-12 self-center'/>
            <div>
                <p className='leading-relaxed m-4 text-2xl text-yellow-300 text-1xl text-ellipsis ml-14 md:text-3xl  mb-10'>
