        ...
        < motion.div className='fixed inset-0 flex items-center justify-center w-full h-full bg-gray-900 bg-opacity-50 z-50' animate={{x:0}} initial={{x:-100}}>
            <div className='bg-white rounded-2xl p-10'>
                <div className='flex justify-between items-center mb-10'>
                    ...
                    <button
                        onClick={onClose}
                        className='w-12 h-12 flex items-center justify-center bg-slate-300 overflow-hidden p-2 rounded-full'
                    >
          ...
          <div className='flex flex-col items-center bg-slate-300 rounded-3xl p-4'>
            <button className='h-44 w-44 flex items-center justify-center  rounded-full overflow-hidden'  onClick={() => openLink('https://www.facebook.com/profile.php?id=100010745164601')}>
          ...
          <div className='flex flex-col items-center bg-slate-300 rounded-3xl p-4'>
            <button className='h-44 w-44 flex items-center justify-center  rounded-full' onClick={()=>openLink('https://www.linkedin.com/in/cruz-marc-eddyson-b216222ba?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app')}>
          ...
          <div className='flex flex-col items-center bg-slate-300 rounded-3xl p-4'>
            <button className='h-44 w-44 flex items-center justify-center  rounded-full overflow-hidden' onClick={()=>openLink('https://discordapp.com/users/mar_ddy/')}>
            ...
            <h1 className='text-center text-gray-800 mt-4'>Discord</h1> 
                ...
                <h1 className='text-2xl text-gray-900 mb-10'>Contact Number:
                    ...
                    }} className='text-2xl text-sky-600 underline'>+63 991 917 0254</a>
                </h1>
                <h1 className='text-2xl text-gray-900 mb-10'>Gmail:
                    <a href="#" onClick={(e) => {
                        e.preventDefault();
